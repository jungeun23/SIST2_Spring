		...
		<div
			...
			<div class="col-md-9 ftco-animate mb-5 text-center">
				<p class="breadcrumbs mb-0">
					...
					<span>
						<a href="/hobbylovey/class/list.action">카테고리 대 
							<i class="fa fa-chevron-right"></i>
						</a>
					</span>
				</p>
				<h2 class="mb-0 bread">카테고리 소</h2>
			</div>
		</div>
	</div>
</section>
					...
					<div class="col-md-9">
						<div class="row mb-4">
							<div class="col-md-12 d-flex justify-content-between align-items-center">
								<h4 class="product-select">인기 카테고리 000</h4>
						...
						<!-- 이거로 작업하시면 됩니다~~ -->
							<div class="col-md-4 d-flex">
								<div class="product ftco-animate">
									...
									<div class="text text-center">
										...
										<p class="mb-0"><span class="price">50,000원</span> <span class="price price-sale">80,000원</span></p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 d-flex">
								<div class="product ftco-animate">
									...
									<div class="text text-center">
										<span class="seller">인기</span>
										<span class="list-star">5.0</span>
										<h2>K-POP 방송댄스 원데이 클래스 (예약 가능)</h2>
							...
							<div class="col-md-4 d-flex">
								<div class="product ftco-animate">
									...
									<div class="text text-center">
										<span class="new">Only</span>
										<span class="">4.8</span>
										<h2>[청담] 소그룹 발레 기초 베이직반 1회 (예약 가능)</h2>
							...
							<div class="col-md-4 d-flex">
								<div class="product ftco-animate">
									<div class="img d-flex align-items-center justify-content-center" style="background-image: url('../resources/images/prod-9.jpg');">
										<div class="desc">
											<p class="meta-prod d-flex">
												<a href="#" class="d-flex align-items-center justify-content-center"><span class="flaticon-shopping-bag"></span></a>
												<a href="#" class="d-flex align-items-center justify-content-center"><span class="flaticon-heart"></span></a>
							...
							<div class="col-md-4 d-flex">
								<div class="product ftco-animate">
									<div class="img d-flex align-items-center justify-content-center" style="background-image: url('../resources/images/prod-10.jpg');">
										<div class="desc">
											<p class="meta-prod d-flex">
												<a href="#" class="d-flex align-items-center justify-content-center"><span class="flaticon-shopping-bag"></span></a>
												<a href="#" class="d-flex align-items-center justify-content-center"><span class="flaticon-heart"></span></a>
							...
							<div class="col-md-4 d-flex">
								<div class="product ftco-animate">
									<div class="img d-flex align-items-center justify-content-center" style="background-image: url('../resources/images/prod-11.jpg');">
										<div class="desc">
											<p class="meta-prod d-flex">
												<a href="#" class="d-flex align-items-center justify-content-center"><span class="flaticon-shopping-bag"></span></a>
												<a href="#" class="d-flex align-items-center justify-content-center"><span class="flaticon-heart"></span></a>
							...
							<div class="col-md-4 d-flex">
								<div class="product ftco-animate">
									<div class="img d-flex align-items-center justify-content-center" style="background-image: url('../resources/images/prod-12.jpg');">
										<div class="desc">
											<p class="meta-prod d-flex">
												<a href="#" class="d-flex align-items-center justify-content-center"><span class="flaticon-shopping-bag"></span></a>
												<a href="#" class="d-flex align-items-center justify-content-center"><span class="flaticon-heart"></span></a>
