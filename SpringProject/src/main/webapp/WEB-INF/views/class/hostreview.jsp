	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate mb-5 text-center">
				...
				<h2 class="mb-0 bread">호스트 소개</h2>
			</div>
		</div>
	</div>
</section>

<div class="product-HostProfilePagePageWrapper gKmYqf">
	<div class="product-Profile-Wrapper gVwBVO">
		<div class="product-Profile-sc dfFYju">
			<div class="product-ProfileInfo-sc ixjLkJ">
				<div class="product-ProfilepageImage hEglGi">
					<div class="product-review-ImageWrapper gDuKGF">
						<img class="product-review-ImageLoader bUFcfh" width="56"
							height="56"
							...
							<div class="Ratio " style="display: block;">
								<div class="Ratio-ratio "
									...
									<div class="Ratio-content "
										...
										<img alt="호스트 프로필 이미지"
											class="Image__StyledImage-v97gyx-1 VUNpu" width="56"
											height="56"
											src="https://res.cloudinary.com/frientrip/image/upload/ar_1:1,c_fill,dpr_1.0,f_auto,h_56,q_auto,w_56/Host_9393_38445_1626421350">
									</div>
								</div>
				...
				<div class="product-ProfileContent fMiunS">
					<div class="product-HostNameWrapper jYAYJP">
						<span class="product-ProfileNickName cZgpqN"><span>Luke</span></span>
					</div>
					<span class="product-ProfileStat cUDkmC">클래스 1 <span class="product-host-profile-stat"> | </span> 후기
						5 <span> | </span>저장 1
					</span>
				</div>
			</div>
	...
	<div class="product-NavigationWrapper fEVfyA">
		<button width="auto" height="60px" font-size="20px" font-weight="bold"
			class="Button-bqxlp0-0 NavigationButton__StyledButton-sc-121z7og-0 hostprofilepgbtn NbmIN">클래스</button>
			<div style="display: inline-block; margin-left: 10px; margin-right: 10px;">|</div>
		<button width="auto" height="60px" font-size="20px" font-weight="300"
			class="Button-bqxlp0-0 NavigationButton__StyledButton-sc-121z7og-0 hostprofilepgbtn-active Ppvwe">후기</button>
	</div>
	
	<div class="Review__Wrapper-sc-1aech36-0 fCmQNq">
			...
			<div class="Review__ReviewListWrapper-sc-1aech36-1 bsLsGZ">
				...
				<div class="product-review-CardReviewWrapper gPxoog">
					...
					<div class="product-review-CardReviewBody cajFtP">춤에 대한 자신감도
						얻어가고 멋있어보이는 동작들을 쉽고 재밌게 배워 갑니다:) 대여한 공간도 넓고 에어컨도 잘나와서 쾌적했어요 ㅎㅎ
						무엇보다 선생님이 동작에 대한 설명을 계속 해주시고 같이 연습하게끔 많이 도와주세요! 초보자여도 걱정 없이 신청해서
						즐겁게 배우고 가실 수 일을 거 같아요👍🏻</div>
					...
					<div class="product-review-CardReviewReplyWrapper jQDxGD">
						<div class="product-review-ReplyEntityWrapper kkZZyy">
											...
											<div class="product-review-Ratio " style="display: block;">
												<div class="product-review-Ratio-ratio "
													...
													<div class="product-review-Ratio-content "
														style="height: 100%; left: 0px; position: absolute; top: 0px; width: 100%;">
														<img alt="작성자 프로필"
															class="product-review-StyledImage VUNpu" width="36"
															src="https://res.cloudinary.com/frientrip/image/upload/ar_1:1,c_fill,dpr_1.0,f_auto,q_auto,w_36/Host_9393_38445_1626421350">
													</div>
												</div>
											</div>
							...
							<div class="product-review-ReplyEntityBody bRwRGE">Leena님
								수업 너무 즐겁게 들어주셔서 저도 텐션이 up Up 되구 재밌었어요 *^_^* !! 다음 수업은 더 재밌게
								준비해갈게요 :) Lets get it !!! :)</div>
						</div>
					</div>
				</div>
				...
				<div class="product-review-CardReviewWrapper gPxoog">
					...
					<div class="product-review-CardReviewBody cajFtP">강사님께서 너무
						친절하게 잘 설명해주셔서 재밌고 유익했어요 :) 난이도가 낮았던 안무였던것 같아서 잘 쉽게 따라할 수 있었습니다~
						다음에 또 기회가 되면 더 재미있는 곡으로 다시 하고 싶어요! 오랜만에 춤 춰서 너무 힘들었지만 친구들과 특별한
						경험이었습니다!</div>
					<div class="product-review-CardReviewPurchaseInfo gtmZdj">
						<div class="product-review-CardReviewProductTitle cpcmqS">[21%▼]
							[서울] 초보자를 위한 Private Dance Class (예약 가능)</div>
